<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('creportes/report_egresosv_detalle');?>"><i class="fa fa-dashboard"></i> Reporte Egresos</a></li>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              ...
              <?php echo anchor('creportes/impr_rep_egresosv_detalle/'.$fecha_desde.'/'.$fecha_hasta.'/'.$tipo_egreso.'/', 'Imprimir', array('class' => 'btn btn-primary btn-xm pull-right','title'=>'Imprimir Reporte')); ?>
            </div>
            <div class="box-body">
