<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('creportes/report_egresosv_detalle');?>"><i class="fa fa-dashboard"></i> Reportes Egresos</a></li>
             ...
             <table class="table table-bordered">
              ...
              <tbody>
               <?php foreach($results as $result): ?>
                <tr>
                  <td><p style="font-size:12px;"><?php echo $result['id_egreso'] ?></p></td>
                  ...
                  <td><?php $total_valor_egresos += $result['valor'] ?></p></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
             </table>
