<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('creportes/report_egresosv_resumen');?>"><i class="fa fa-dashboard"></i> Reporte Egresos Resumen</a></li>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              ...
              <?php echo anchor('creportes/impr_rep_egresosv_resumen/'.$fecha_desde.'/'.$fecha_hasta.'/'.$tipo_egreso.'/', 'Imprimir', array('class' => 'btn btn-primary btn-xm pull-right','title'=>'Imprimir Reporte')); ?>
            </div>
            <div class="box-body">
